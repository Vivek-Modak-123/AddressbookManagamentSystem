...
public class Add extends Main{
	public static void add_contact() throws IOException, FileNotFoundException{
		...
		if(f1 == "" || f2 == "" || f5 == "" || f6 == "" || f8 == "" || f3 == "" || f4 == "" || f7 == -1 || f9 == -1) {//i check that all variables have a valid attribute assigned
			...
			str = f1 + "," + f2 + "," + f3 + "," + f4 + "," + f5 + "," + f6 + "," + String.valueOf(f7) + "," + f8 + "," + String.valueOf(f9);
