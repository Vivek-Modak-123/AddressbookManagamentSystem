...
public class Main {
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			System.out.println("Do you want to print contacts, add contact, search for contact or edit contact?");
			System.out.println("Answer with '1', '2', '3', '4' or '0' to exit application.");	
